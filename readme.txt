--------------------------------------------------------------------------------
--
-- Travelpoints Textures 512 1.0                                      2015-03-24
--
-- By Racso Rhodes
--
-- travelpoints-textures-512/readme.txt
--
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
	...
	About
		...
		512x512 textures for the Minetest mod "Travelpoints".
	...
	Install
		...
		For example, if you are using "HDX 512", you would move these files to
		the textures/HDX_512px directory in your Minetest installation directory.
